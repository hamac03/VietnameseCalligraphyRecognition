...
for image_path, gt_label in groundtruth.items():
    pred_labels = {method_dataset: predictions[method_dataset].get(image_path, "N/A") for method_dataset in prediction_files}
    unique_predictions = set(pred_labels.values().lower())
...
# Tạo hai file HTML
output_same = "/mlcv2/WorkingSpace/Personal/hamh/Ha/Methods/DemoSTR/CCD_stroke/visualization/visualizationsame_predictions.html"
output_different = "/mlcv2/WorkingSpace/Personal/hamh/Ha/Methods/DemoSTR/CCD_stroke/visualization/visualizationdifferent_predictions.html"
