...
def main(args):
    dest_path = f'/mlcv2/WorkingSpace/Personal/hamh/Ha/Methods/DemoSTR/STR_prediction_results/STR/{args.rec_algorithm}.txt'
    ...
    with open(dest_path, encoding='utf-8', mode='a') as file:
        for ino in range(len(img_list)):
            ...
            # )
            file.write(f"{valid_image_file_list[ino]}\t{rec_res[ino][0]}\n")
    if args.benchmark:
