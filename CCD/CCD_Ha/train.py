...
def train(config):
    ...
    # imgnet_based = config.imgnet_based

    # # Print each value
    # print("Training Epochs:", training_epochs)
    # print("Length of Train Dataloader:", dataloader_length)
    # print("Batch Size Per GPU:", batch_size_per_gpu)
    # print("World Size:", world_size)
    # print("ImageNet Based:", imgnet_based)

    # Calculate intermediate results
    # total_steps = training_epochs * dataloader_length * batch_size_per_gpu * world_size
    # print("Total Steps Before Division:", total_steps)

    # Division by `imgnet_based`
    # epochs_before_int = total_steps / imgnet_based
    # print("Epochs Before Conversion to Integer:", epochs_before_int)

    # Final result
    # config.epochs = int(epochs_before_int) + 1
    # print("Final Config Epochs:", config.epochs)
