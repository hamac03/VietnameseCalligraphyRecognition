...
char_to_num = read_vietnamese_characters("Vietnamese-Characters-Simplified.txt")
...
def rectify(stroke: str, list_strokes: List[str]) -> str:
    ...
    similarities = [DamerauLevenshtein.normalized_similarity(stroke, i) for i in list_strokes]
