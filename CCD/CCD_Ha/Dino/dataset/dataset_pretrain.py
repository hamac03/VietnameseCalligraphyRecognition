...
from utils import encode_vietnamese_character, read_vietnamese_characters, decode_word, encode_word
char_to_num = read_vietnamese_characters("Vietnamese-Characters-Simplified_full.txt")



def encode_label(label, char_to_num):
    return '-'.join(map(str, encode_word(label, char_to_num)))
    ...
    def get(self, idx):
        with self.env.begin(write=False) as txn:
            ...
            try:
                ...
                raw_label = encode_label(raw_label, char_to_num)
                # print(raw_label)
                ...
                if self.is_training:
                    ...
                    if targets_dict[0][0] == targets_dict[0][1] and targets_dict[0][1] == 224: # old is 91 check DICT90
                        # print(raw_label)
                        return self._next_image()
                else:
