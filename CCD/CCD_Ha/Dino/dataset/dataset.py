...
class ImageDataset(Dataset):
    ...
    def __init__(self,
                 ...
                 mask: bool = False,
                 mask_path: str = '/mlcv2/WorkingSpace/Personal/hamh/Ha/Methods/CCD/CCD_Ha/mask_lmdb/',
                 **kwargs):
        ...
        try:
            ...
            sub_file = path.split('/')[-2]
            print(f"using {mask_path}")
            self.mask_env = lmdb.open(mask_path,
            ...
            print(f'{str(path)} not use {mask_path} as loading mask lmdb file!')
    ...
    def get(self, idx):
        with self.env.begin(write=False) as txn:
            ...
            try:
                ...
                # mask = clusterpixels(image.convert("L"), 2)  # Tạo mask với 2 cụm
                # print(f"Create mask online.")
