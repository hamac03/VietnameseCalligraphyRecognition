...
class Trainer:
    ...
    def predict(self, sample=None):
        ...
        for batch in self.valid_gen:
            ...
            total_time += (end_time - start_time)  # Cộng dồn thời gian
        ...
        return pred_sents, actual_sents, img_files, prob, avg_time_per_image

    def precision(self, sample=None):

        pred_sents, actual_sents, _, _, avg_time_per_image = self.predict(sample=sample)
        acc_full_seq = compute_accuracy(actual_sents, pred_sents, mode="full_sequence")
        acc_per_char = compute_accuracy(actual_sents, pred_sents, mode="per_char")
        cer = compute_accuracy(actual_sents, pred_sents, mode="cer")
        # print("Hello")
        
        return acc_full_seq, acc_per_char, cer, avg_time_per_image
